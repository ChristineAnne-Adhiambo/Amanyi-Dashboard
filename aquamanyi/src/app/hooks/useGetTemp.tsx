...
const useGetTemp = () => {
  ...
  const getTemperatureData = () => {
    return temp.map((data) => ({
      x: new Date(data.Timestamp).toLocaleString(), // Convert to localized date and time string
  ...
  const getTableData = () => {
    return temp.map((data) => ({
      ...
      time: new Date(data.Timestamp).toLocaleString(), // Convert to localized date and time string
    }));
  };
