...
const HomePage = () => {
  ...
  <input
    type="text"
    placeholder="Search"
    className="w-[200px] h-[40px] px-4 mr-10 mt-4 py-2 text-gray-800 border border-gray-800 rounded-lg"
    value={searchTerm}
...
<div className="flex justify-center gap-40 mt-10 space-x-8">
<div className="border-4 p-4 max-w-lg rounded-lg text-white bg-sky-500/100 flex items-center h-30">
  <FaTint size={50} className="text-white mx-auto" />
  <button
  className="text-white ml-2 w-200"
...
>
  ...
  <FaThermometerThreeQuarters size={60} className="text-white mx-auto" />
  <button
...
<div className="bg-white-200 p-4 font-semibold rounded-lg shadow-lg mr-40 ">
            ...
            <BarChart width={400} height={400} ml-38 data={dailyTemperatureData}>
